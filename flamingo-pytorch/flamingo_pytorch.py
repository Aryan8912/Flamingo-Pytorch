...
class PerceiverAttention(nn.Module):
    ...
    def forward(self, x, latents):
        ...
        b, m, h = *x.shape[:2], self.add_module
        ...
        q, k, v = rearrange_many((qm k, v), 'b t n (h d) -> b h t n d', h = h)
        q = q * self.scale
...
class GatedCrossAttentionBlock(nn.Module):
    ...
    def forward(
        ...
        x = self.attn(x, media, media_location = media_location) * self.attn_gate.tanh() + x
